  ...
  const programs = [
    {
      ...
      image:
        "https://shrishankaracharya.org/wp-content/uploads/2024/05/kanha-kids-a-play-school-and-day-care-kolar-road-bhopal-schools-0dggajqcgh-2.jpg",
      achievements: [
    ...
    },
    {
      ...
      image: "https://shrishankaracharya.org/wp-content/uploads/2024/05/Tribal-culinary-skills.jpg",
      achievements: [
    ...
    },
    {
      ...
      image: "https://shrishankaracharya.org/wp-content/uploads/2024/05/Picture22.png",
      achievements: [
    ...
    <section className="py-8 lg:py-16 bg-gradient-to-br from-gray-50 to-blue-50/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 lg:mb-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-8">
            ...
            <div className="w-full lg:w-auto overflow-x-auto">
              <div className="flex space-x-1 lg:space-x-2 p-1 bg-gray-100 rounded-2xl w-max mx-auto lg:mx-0">
                {programs.map((program, index) => (
                  <button
                    key={program.id}
                    onClick={() => handleProgramClick(index)}
                    className={`px-4 py-3 lg:px-6 lg:py-4 rounded-xl text-sm lg:text-base font-semibold transition-all duration-300 flex items-center gap-3 min-w-max ${
                      activeIndex === index
                        ? "text-white shadow-lg transform scale-105"
                        : "text-gray-700 bg-transparent hover:bg-white/50"
                    }`}
                    style={{
                      backgroundColor:
        ...
        <div className="relative">
                  ...
                  <div className="bg-white rounded-3xl overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
                      ...
                      <div className="relative h-80 lg:h-auto">
                        ...
                        />
                        <div
                          className="absolute inset-0 bg-gradient-to-br from-black/20 to-black/10"
                          style={{
                            backgroundColor: `${program.color}15`,
                            backgroundImage: `linear-gradient(135deg, ${program.color}15 0%, ${program.color}05 100%)`,
                          }}
                        >
                          {/* Background Pattern */}
                          <div
                          ...
                          <div className="absolute inset-0 flex flex-col justify-between p-8 text-white">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-4">
                                <div
                                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold text-white backdrop-blur-sm border border-white/20"
                                  style={{
                                    backgroundColor: `${program.color}80`,
                                  }}
                                >
                                  <div className="w-2 h-2 bg-white/80 rounded-full animate-pulse"></div>
                                  {program.stats}
                      ...
                      <div className="p-6 lg:p-8 xl:p-12 flex flex-col justify-center">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                          <div className="text-center p-4 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 shadow-sm">
                            <Users
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            {program.achievements.map((achievement, i) => (
                              <div
                                key={i}
                                className="flex items-center gap-4 p-4 bg-gradient-to-r from-gray-50 to-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300"
                              >
                                <div
                                  className="w-8 h-8 rounded-full flex items-center justify-center text-white flex-shrink-0 shadow-lg"
                                  style={{ backgroundColor: program.color }}
                                >
                                  <Check size={16} />
                                </div>
          ...
          {/* Custom Pagination */}
          <div className="custom-pagination flex justify-center items-center gap-4 mt-8 text-lg font-semibold text-gray-700"></div>
        </div>
      </div>
    </section>
  );
